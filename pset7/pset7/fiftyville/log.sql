...
SELECT * FROM phone_calls INNER JOIN people ON phone_calls.receiver = people.phone_number WHERE day = 28 AND month = 7 AND year = 2021 and duration < 60 AND people.name = "Diana";
